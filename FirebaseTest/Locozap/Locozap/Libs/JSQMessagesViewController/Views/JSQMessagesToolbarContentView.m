...
{
    UIColor *f2 = [UIColor colorWithRed:242.0/255.0 green:242.0/255.0 blue:242.0/255.0 alpha:1];
    [super setBackgroundColor:f2];
    self.leftBarButtonContainerView.backgroundColor = f2;
    self.rightBarButtonContainerView.backgroundColor = f2;
...
- (void)setRightBarButtonItem:(UIButton *)rightBarButtonItem
{
    ...
    self.rightHorizontalSpacingConstraint.constant = kJSQMessagesToolbarContentViewHorizontalSpacingDefault;
    self.rightBarButtonItemWidth = CGRectGetWidth(rightBarButtonItem.frame) + 10;

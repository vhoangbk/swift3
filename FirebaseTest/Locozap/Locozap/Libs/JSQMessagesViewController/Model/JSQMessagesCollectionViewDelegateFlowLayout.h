...
- (void)collectionView:(JSQMessagesCollectionView *)collectionView didTapLikeView:(UIView *)likeView atIndexPath:(NSIndexPath *)indexPath;

- (void)collectionView:(JSQMessagesCollectionView *)collectionView didPressRetryButton:(UIButton *)button atIndexPath:(NSIndexPath *)indexPath;

- (void)collectionView:(JSQMessagesCollectionView *)collectionView didTapLink:(NSURL *)nsUrl;

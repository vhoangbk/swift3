...
@property NSString *userTyping;

@property (assign, nonatomic) BOOL showViewLike;
...
@property (strong, nonatomic) IBOutlet UIView *viewHeaderContent;
@property (weak, nonatomic) IBOutlet UIView *viewExpand;
@property (weak, nonatomic) IBOutlet UIImageView *imgHeaderArrow;
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *heightContrainViewHeaderContent;

@property (weak, nonatomic) IBOutlet UILabel *lbGroupTitle;
@property (weak, nonatomic) IBOutlet UIImageView *imgCategory;
@property (weak, nonatomic) IBOutlet UILabel *lbGroupTitle1;
@property (weak, nonatomic) IBOutlet UILabel *lbAddress;
@property (weak, nonatomic) IBOutlet UILabel *lbGroupContent;
...
@property (weak, nonatomic) IBOutlet UIScrollView *scrollHeader;
@property (strong, nonatomic) IBOutlet UIView *viewContentScroll;


@property (weak, nonatomic) IBOutlet NSLayoutConstraint *constraintTopCollectionView;

- (IBAction)pressBack:(id)sender;
@property (strong, nonatomic) IBOutlet UIButton *bntBack;
@property (strong, nonatomic) IBOutlet UILabel *lbtitleHeader;

- (void) handlerTabAvatar;
@property (weak, nonatomic) IBOutlet UILabel *lbTyping;
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *constraintTyingButton;
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *constraintHeightHeaderContent;

...
open class DatePickerDialog: UIView {
    ...
    open func show(_ title: String, doneButtonTitle: String = NSLocalizedString("btn_ok", comment: ""), cancelButtonTitle: String = NSLocalizedString("cancel", comment: ""), defaultDate: Date = Date(), minimumDate: Date? = nil, maximumDate: Date? = nil, datePickerMode: UIDatePickerMode = .dateAndTime, callback: @escaping DatePickerCallback) {

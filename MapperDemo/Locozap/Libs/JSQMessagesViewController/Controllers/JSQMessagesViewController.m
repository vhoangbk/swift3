...
- (void)jsq_configureMessagesViewController
{
    ...
    self.inputToolbar.contentView.textView.placeHolder = NSLocalizedString(@"enter_message", @"");
...
- (UICollectionViewCell *)collectionView:(JSQMessagesCollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.accessibilityIdentifier = [NSString stringWithFormat:@"(%ld, %ld)", (long)indexPath.section, indexPath.row];
...
//            }
            ...
            [cell.avatarImageView sd_setImageWithURL:[NSURL URLWithString:[avatarImageDataSource avatarImageLink]]];
        }
    }
